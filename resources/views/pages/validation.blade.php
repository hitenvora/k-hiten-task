...
@section('subhead')
    <title>Validation - Kanaiya</title>
@endsection
                    ...
                    <x-base.preview>
                        ...
                        <form class="validate-form">
                            ...
                            <div class="input-form mt-3">
                                <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-2">
                                    Email
                                    <span class="mt-1 text-xs text-slate-500 sm:ml-auto sm:mt-0">
                                        Required, email address format
                                    </span>
                                </x-base.form-label>
                                <x-base.form-input class="form-control" id="validation-form-2" name="email" type="email"
                                    placeholder="example@gmail.com" required />
                            </div>
                            <div class="input-form mt-3">
                                <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-3">
                                    Password
                                    <span class="mt-1 text-xs text-slate-500 sm:ml-auto sm:mt-0">
                                        Required, at least 6 characters
                                    </span>
                                </x-base.form-label>
                                <x-base.form-input class="form-control" id="validation-form-3" name="password"
                                    type="password" placeholder="secret" minlength="6" required />
                            </div>
                            <div class="input-form mt-3">
                                <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-4">
                                    Age
                                    <span class="mt-1 text-xs text-slate-500 sm:ml-auto sm:mt-0">
                                        Required, integer only & maximum 3 characters
                                    </span>
                                </x-base.form-label>
                                <x-base.form-input class="form-control" id="validation-form-4" name="age" type="number"
                                    placeholder="21" required />
                            </div>
                            <div class="input-form mt-3">
                                <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-5">
                                    Profile URL
                                    <span class="mt-1 text-xs text-slate-500 sm:ml-auto sm:mt-0">
                                        Optional, URL format
                                    </span>
                                </x-base.form-label>
                                <x-base.form-input class="form-control" id="validation-form-5" name="url" type="url"
                            ...
                            <div class="input-form mt-3">
                                ...
                                <x-base.form-textarea class="form-control" id="validation-form-6" name="comment"
                                    placeholder="Type your comments" minlength="10" required></x-base.form-textarea>
                            </div>
                            <x-base.button class="mt-5" type="submit" variant="primary">
                                Register
                            </x-base.button>
                        </form>
                        <!-- END: Validation Form -->
                        ...
                        <x-base.highlight>
                            ...
                            <form class="validate-form">
                                <div class="input-form">
                                    ...
                                    <x-base.form-input class="form-control" id="validation-form-1" name="name"
                                        type="text" placeholder="John Legend" minlength="2" required />
                                </div>
                                <div class="input-form mt-3">
                                    <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-2">
                                        Email
                                    ...
                                    <x-base.form-input class="form-control" id="validation-form-2" name="email"
                                ...
                                <div class="input-form mt-3">
                                    <x-base.form-label class="flex w-full flex-col sm:flex-row"
                                    ...
                                    <x-base.form-input class="form-control" id="validation-form-4" name="age"
                                ...
                                <div class="input-form mt-3">
                                    ...
                                    <x-base.form-input class="form-control" id="validation-form-5" name="url"
