                        ...
                        <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                            <div @class([
                                ...
                                <div class="box p-5">
                                    ...
                                    <div class="mt-6 text-3xl font-medium leading-8">{{$appOrder}}</div>
                                    <div class="mt-1 text-base text-slate-500">App Orders</div>
                                </div>
                            </div>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                            <div @class([
                                ...
                                <div class="box p-5">
                                    ...
                                    <div class="mt-6 text-3xl font-medium leading-8">{{$Admin_Bulk_Order}}</div>
                                    <div class="mt-1 text-base text-slate-500">Admin Orders</div>
                                </div>
                            </div>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                            <div @class([
                                ...
                                <div class="box p-5">
                                    ...
                                    <div class="mt-6 text-3xl font-medium leading-8">{{$Ecom_Order}}</div>
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                            <div @class([
                                ...
                                <div class="box p-5">
                                    ...
                                    <div class="mt-6 text-3xl font-medium leading-8">{{$Product}}</div>
                                    <div class="mt-1 text-base text-slate-500">
                                        Total Products
                                    </div>
                                </div>
