...
@section('subhead')
    <title>Admin | Automation History List</title>
@endsection
        ...
        <div class="scrollbar-hidden overflow-x-auto">
            <div class="overflow-x-auto">
                <table data-tw-merge class="w-full text-left" id="example">
                    ...
                    <tbody>
                        @php $count = 1; @endphp
                        @foreach ($automationHistory as $item)
                            <tr data-tw-merge
                                class="[&amp;amp;:nth-of-type(odd)_td]:bg-slate-100 [&amp;amp;:nth-of-type(odd)_td]:dark:bg-darkmode-300 [&amp;amp;:nth-of-type(odd)_td]:dark:bg-opacity-50">
                                ...
                                <td data-tw-merge class="px-5 py-3 border-b dark:border-darkmode-300">
                                    {{ $item->GetAutomationHistory->product_name ?? null }}
                                    {{ $item->GetAutomationHistory ? ' to ' . $item->GetAutomationHistory->product_name : '' }}
                                </td>
                                <td data-tw-merge class="px-5 py-3 border-b dark:border-darkmode-300">
                                    @if ($item->type == 1)
                                        MANY TO ONE
