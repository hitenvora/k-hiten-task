    ...
    <div class="policy margin_top80">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <p>Welcome to 24 Carats Sweets!</p>
                    <p>These terms and conditions outline the rules and regulations for the use of 24 Carats Sweets’s
                        Website, located at <a href="https://www.24caratssweets.com/"> https://www.24caratssweets.com/.</a>
                    </p>
                    <p>By accessing this website, we assume you accept these terms and conditions. Do not continue to use 24
                        Carats Sweets if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <p>We employ the use of cookies. By accessing 24 Carats Sweets, you agreed to use cookies in agreement
                        with the 24 Carats Sweets’s Privacy Policy.</p>
                ...
                <div class="col-lg-12">
                    <p>Unless otherwise stated, 24 Carats Sweets and/or its licensors own the intellectual property rights
                        for all material on 24 Carats Sweets. All intellectual property rights are reserved. You may access
                        this from 24 Carats Sweets for your own personal use subjected to restrictions set in these terms
                        and conditions.</p>
                </div>
                <div class="col-lg-12">
                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from 24 Carats Sweets</li>
                        <li>Sell, rent or sub-license material from 24 Carats Sweets</li>
                        <li>Reproduce, duplicate or copy material from 24 Carats Sweets</li>
                        <li>Redistribute content from 24 Carats Sweets</li>
                    </ul>
                </div>
                <div class="col-lg-12">
                    <p>&nbsp;</p>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                        certain areas of the website. 24 Carats Sweets does not filter, edit, publish or review Comments
                        prior to their presence on the website. Comments do not reflect the views and opinions of 24 Carats
                        Sweets,its agents and/or affiliates. Comments reflect the views and opinions of the person who post
                        their views and opinions. To the extent permitted by applicable laws, 24 Carats Sweets shall not be
                    ...
                    <p>24 Carats Sweets reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    <p>You hereby grant 24 Carats Sweets a non-exclusive license to use, reproduce, edit and authorize
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                        ...
                        the absence of 24 Carats Sweets; and (d) the link is in the context of general resource information.
                    </p>
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                        website, you must inform us by sending an e-mail to 24 Carats Sweets. Please include your name, your
                    ...
                    <p>No use of 24 Carats Sweets’s logo or other artwork will be allowed for linking absent a trademark
                        license agreement.</p>
                </div>
            </div>
            <div class="row">
