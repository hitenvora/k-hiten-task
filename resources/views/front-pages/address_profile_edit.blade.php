    ...
    <div class="new-address margin_top100">
        <div class="container">
            <div class="new_adderss_form padding_top50">
                ...
                <form action="{{ route('update_profile_address', ['id' => $edit_profile_address->id ?? null]) }}"
                    class="margin_top20" id="address_profile_form" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="name" class="form-control" id="first_name" name="first_name"
                                    ...
                                    value="{{ $edit_profile_address->first_name }}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="name" class="form-control" name="last_name" id="last_name"
                                    ...
                                    value="{{ $edit_profile_address->last_name }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" id="email"
                                    ...
                                    value="{{ $edit_profile_address->email }}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="name" class="form-control" name="mobile_no" id="mobile_no"
                                    ...
                                    value="{{ $edit_profile_address->mobile_no }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        {{-- <div class="col-lg-4">
                            <div class="form-group">
                                <input type="text" class="form-control" name="pincode" id="pincode"
                                    ...
                                    value="{{ $edit_profile_address->pincode }}">
                            </div>
                        </div> --}}
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="text" class="form-control" name="city" id="city"
                                    ...
                                    value="{{ $edit_profile_address->city }}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="text" class="form-control" name="state" id="state"
                                    ...
                                    value="{{ $edit_profile_address->state }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="addresss" name="addresss"
                            ...
                            value="{{ $edit_profile_address->addresss }}">
                    </div>


                    <input type="hidden" name="address_type" value="{{ $edit_profile_address->address_type ?? '0' }}">

                    <div class="office margin_top20">
                        <div class="office-home">
                            <a href="#" id="home"
                                class="office-home @if ($edit_profile_address->address_type == 0) selected @endif"
                                onclick="selectAddressType(0)">
                                <i class="fa-solid fa-house"></i> HOME
                            </a>
                        </div>
                        <div class="office-home">
                            <a href="#" id="office"
                                class="office-home @if ($edit_profile_address->address_type == 1) selected @endif"
                                onclick="selectAddressType(1)">
                                <i class="fa-solid fa-briefcase"></i> OFFICE
                            </a>
                        </div>
                        <div class="office-home">
                            <a href="#" id="other"
                                class="office-home @if ($edit_profile_address->address_type == 2) selected @endif"
                                onclick="selectAddressType(2)">
