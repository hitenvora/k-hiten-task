...
@section('subcontent')
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('save.ProdcutReturnSubmit') }}" method="POST"
    ...
    <script>
        ...
        document.addEventListener('change', function(event) {
            if (event.target && event.target.id === 'product') {
                ...
                var url = '{{ url('fetchProductForReturnOrder') }}';
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (let key in jsonObject) {
                            ...
                            for (let nestedKey in jsonObject) {
                                let value = jsonObject[key];
                                console.log('nestedKey', jsonObject[key]);
                        ...
                        gst.value = data.data.taxes;

                        const gstAmount = price * (data.data.taxes / 100);
