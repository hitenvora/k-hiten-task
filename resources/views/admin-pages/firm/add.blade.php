...
@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Add Firm</h2>
    </div>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('save.firm') }}" method="POST">
                @csrf
                <div class="intro-y box p-5">
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="validation-form-1" name="name" type="text"
                            placeholder="Firm Name" minlength="2" required />
                    </div>
                    <div class="mt-3">
                        <x-base.form-label for="crud-form-2">Gst & Text</x-base.form-label>
                        <x-base.tom-select class="w-full" name="gst_text[]" id="crud-form-2" multiple>
