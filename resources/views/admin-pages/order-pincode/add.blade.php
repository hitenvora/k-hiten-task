...
@section('subhead')
    <title>ADD Order Pincode</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">ADD Order Pincode</h2>
        @if ($errors->any())
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form method="POST" class="customers-validate-form" action="{{ route('save.order_pincode') }}"
                ...
                <div class="intro-y box p-5">
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="pincode" type="text" name="pincode" required />
