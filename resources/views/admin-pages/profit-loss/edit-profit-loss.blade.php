...
@section('subhead')
    <title>Edit Profite-Loss</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Edit Profite-Loss</h2>
        @if ($errors->any())
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form method="POST" class="customers-validate-form"
                action="{{ route('profite-loss.update', $editProfile_loss->id) }}">
                @csrf
                <div class="intro-y box p-5">
                    <div class="mt-3">
                        <div class="input-form">
                            ...
                            <select data-tw-merge aria-label=".form-select-lg example" id="profilt_lose"
                                ...
                                <option value="0" {{ $editProfile_loss->profilt_lose == 0 ? 'selected' : '' }}>Profite
                                </option>
                                <option value="1" {{ $editProfile_loss->profilt_lose == 1 ? 'selected' : '' }}>Loss
                                </option>
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="description" type="text" name="description"
                            value="{{ $editProfile_loss->description }}" />
                    ...
                    {{-- <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="qty_in_sold" type="text" name="qty_in_sold"
                            value="{{ $editProfile_loss->qty_in_sold }}" />
                    </div>
                    <div class="input-form">
                        <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-1"
                            for="inventry_value">
                        ...
                        <x-base.form-input class="form-control" id="inventry_value" name="inventry_value" type="text"
                            value="{{ $editProfile_loss->inventry_value }}" />
                    </div>
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="sale_value" type="text" name="sale_value"
                            value="{{ $editProfile_loss->sale_value }}" />
                    </div>
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="avalible_stock" type="text" name="avalible_stock"
                            value="{{ $editProfile_loss->avalible_stock }}" />
                    </div> --}}
