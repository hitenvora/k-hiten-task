...
@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Edit Categorie</h2>
    </div>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('update.categorie', $category->id) }}" method="POST">
                @csrf
                <div class="intro-y box p-5">
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="validation-form-1" name="name" type="text"
                            value="{{ $category->name ?? '' }}" placeholder="Categorie Name" minlength="2" required />
                    </div>
