...
@section('subcontent')
    ...
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Add Ledger</h2>
    </div>
    @if ($errors->any())
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('save.ledger') }}" method="POST"
                    ...
                    <div class="row">
                        <div class="column">
                            ...
                            <div class="input-form ">
                                ...
                                <x-base.form-input class="form-control" id="name" name="name" required
                            ...
                            <div class="mt-3">
                                <div class="input-form">
                                    ...
                                    <x-base.form-input class="form-control" id="pin_code" name="pin_code" type="text"
                            ...
                            <div class="mt-3">
                                <div class="input-form ">
                                    ...
                                    <x-base.form-input class="form-control" id="email" name="email" type="email"
                            ...
                            <div class="mt-3">
                                <div class="input-form ">
                                    ...
                                    <x-base.form-input class="form-control" id="phone_no" name="phone_no" type="Number"
                            ...
                            <div class="mt-3">
                                <div class="input-form ">
                                    ...
                                    <x-base.form-input class="form-control" id="gst_no" name="gst_no" type="text"
                                        placeholder="Gst No." />
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                <div class="input-form ">
                                    ...
                                    <x-base.form-input class="form-control" id="state" name="state" type="text"
                                        placeholder="State" />
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                <div class="input-form">
                                    ...
                                    <select data-tw-merge aria-label=".form-select-lg example" id="balancing_method"
                                        ...
                                        <option value="1">Fifo Base</option>
                            ...
                            <div class="mt-3">
                                <div class="input-form ">
                                    ...
                                    <x-base.form-input class="form-control" id="mail_to" name="mail_to" required
                                        type="text" placeholder="Mail To" required />
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                <div class="input-form ">
                                    ...
                                    <x-base.form-textarea class="form-control" id="address" name="address"
                                        placeholder="Address"></x-base.form-textarea>
                                </div>
                            </div>
                        ...
                        <div class="column">
                            ...
                            <div class="input-form ">
                                ...
                                <x-base.form-input class="form-control" id="contact_person" name="contact_person"
                            ...
                            <div class="mt-3">
                                <div class="input-form">
                                    ...
                                    <x-base.form-input class="form-control" id="designation" name="designation"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-form">
                                    ...
                                    <x-base.form-input class="form-control" id="gst_heading" name="gst_heading"
                                        type="text" placeholder="GST Heading" required />
                                </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-form ">
                                    ...
                                    <x-base.form-textarea class="form-control" id="note" name="note"
                                        placeholder="Note" required></x-base.form-textarea>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                <div class="input-form">
                                    ...
                                    <select data-tw-merge aria-label=".form-select-lg example" id="ledger_category"
                                        class="disabled:bg-slate-100 disabled:cursor-not-allowed disabled:dark:bg-darkmode-800/50 [&amp;[readonly]]:bg-slate-100 [&amp;[readonly]]:cursor-not-allowed [&amp;[readonly]]:dark:bg-darkmode-800/50 transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3 pr-8 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 text-lg py-1.5 pl-4 pr-8 sm:mt-2 sm:mr-2 sm:mt-2 sm:mr-2"name="ledger_category"
                                        required>
                                        <option value="">Please Select Ledger Category</option>
                                        <option value="1">Retailers</option>
                                        <option value="2">Stock List</option>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-form">
                                    ...
                                    <x-base.form-input class="form-control" id="country" name="country" type="text"
                                        placeholder="Country" />
                                </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-form">
                                    ...
                                    <x-base.form-input class="form-control" id="pan_no" name="pan_no" type="text"
                                        placeholder="Pan NO." />
                                </div>
