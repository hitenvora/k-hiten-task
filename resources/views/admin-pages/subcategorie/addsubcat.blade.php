...
@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Add Categories</h2>
    </div>
    
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('save.subCategorie') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <script>
        $(".customers-validate-form").validate({
            ...
            messages: {
                ...
                image: {
                    required: "Please Select Categorie Image",
                },
            }
        });
    </script>
