...
@section('subhead')
    <title>Update Front Image</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Update Front Image</h2>
        @if ($errors->any())
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form method="POST" class="customers-validate-form"
                action="{{ route('front_image.update', ['id' => $editaddfront_image->id ?? null]) }}"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="old_image" id="old_image" value="{{ $editaddfront_image->image }}">
                <div class="intro-y box p-5">
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="title" type="text" name="title"
                            value="{{ $editaddfront_image->title }}" required />
                    </div>
                    <div class="input-form ">
                        <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="Front Image-image">
                            Front Image Image
                        </x-base.form-label>
                        <div class="drop-zone">

                            <input type="file" name="image" class="drop-zone__input">
                            @if ($editaddfront_image->image)
                                <img src="{{ asset($editaddfront_image->image) }}"
