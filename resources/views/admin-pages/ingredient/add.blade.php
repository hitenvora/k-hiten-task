...
@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Add Ingredient</h2>
    </div>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('save.ingredient') }}" method="POST"
                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="mrp" name="mrp" type="text"
                            placeholder="MRP" min="0" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"/>
                    </div>
                    <div class="input-form">
                        <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-1">
                            Quantity
                        ...
                        <x-base.form-input class="form-control" id="qty" name="qty" type="text"
                            placeholder="Quantity" min="0" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" />
                    </div>
                    <div class="mt-3">
