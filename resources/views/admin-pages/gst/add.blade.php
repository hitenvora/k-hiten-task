...
@section('subhead')
    <title>Add Gst & Text</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Add Gst & Text</h2>
    </div>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('save.gst') }}" method="POST">
                @csrf
        ...
        <x-base.notification class="flex hidden" id="failed-notification-content">
            ...
            <div class="ml-4 mr-4">
                <div class="font-medium">Add Gst & Text failed!</div>
