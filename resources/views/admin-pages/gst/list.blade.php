...
@section('subhead')
    <title>Admin | Gst & Text List</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex flex-col items-center sm:flex-row">
        <h2 class="mr-auto text-lg font-medium">Gst & Text</h2>
                            ...
                            <tr data-tw-merge
                                ...
                                <td data-tw-merge class="px-5 py-3 border-b dark:border-darkmode-300">
                                    {{-- <div class="flex items-center justify-center"> --}}
                                        <a class="mr-3 flex items-center" href="{{ route('edit.gst',$item->id) }}">
...
@once
    ...
    <script>
        function goToAddCategoriePage() {
            ...
            window.location.href = "{{ route('add.gst') }}";
        }
    </script>
@endonce
