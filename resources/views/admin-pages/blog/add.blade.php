...
@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">ADD Blog</h2>
        @if ($errors->any())
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form method="POST" class="customers-validate-form" action="{{ route('save.blog') }}"
                ...
                <div class="intro-y box p-5">
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="title" type="text" name="title" required />
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="message" type="text" name="message" required />
                    </div>
                    {{-- <div class="input-form ">
                        <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-1">
                            Image
