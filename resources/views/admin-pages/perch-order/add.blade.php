...
@section('subcontent')
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('save.perch.order') }}" method="POST"
                                    ...
                                    <div class="flex flex-wrap ">
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="check_number" style="display: none;">
                                                    ...
                                                    <div class="relative flex items-stretch w-full">
                                                        <x-base.form-input class="form-control" name="check_number"
                                                            ...
                                                            onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"
                                                            value="0" pattern="^\d*(\.\d{0,2})?$" minlength="1"
                                                            required />
                                                    </div>
                                                </div>
                                                <div class="rtgs_number" style="display: none;">
