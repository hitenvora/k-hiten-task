...
@section('subhead')
    <title>Admin |party List</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex flex-col items-center sm:flex-row">
        <h2 class="mr-auto text-lg font-medium">Purchase party</h2>
        @if (session('success'))
                            ...
                            <tr data-tw-merge
                                ...
                                <td data-tw-merge class="px-5 py-3 border-b dark:border-darkmode-300">
                                    ...
                                    <a class="mr-3 flex items-center"
                                        href="{{ route('admin.edit.perchparty', $item->id) }}">
...
@once
    ...
    <script>
        ...
        function goToAddCategoriePage() {
            ...
            window.location.href = "{{ route('admin.add.perchparty') }}";
        }
    </script>
@endonce
