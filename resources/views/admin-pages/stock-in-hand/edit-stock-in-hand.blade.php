...
@section('subhead')
    <title>Edit Stock In Hand</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Edit Stock In Hand</h2>
        @if ($errors->any())
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form method="POST" class="customers-validate-form"
                action="{{ route('stock-in-hand.update', $editPerchParty->id) }}">
                @csrf
                <div class="intro-y box p-5">
                    <div class="mt-3">
                        <div class="input-form">
                            <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="product_id">
                                Select Product
                            </x-base.form-label>
                            <select data-tw-merge aria-label=".form-select-lg example" id="product_id"
                                class="disabled:bg-slate-100 disabled:cursor-not-allowed disabled:dark:bg-darkmode-800/50 [&amp;[readonly]]:bg-slate-100 [&amp;[readonly]]:cursor-not-allowed [&amp;[readonly]]:dark:bg-darkmode-800/50 transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3 pr-8 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 text-lg py-1.5 pl-4 pr-8 sm:mt-2 sm:mr-2 sm:mt-2 sm:mr-2"name="product_id">
                                ...
                                @foreach ($productsList as $data)
                                    <option value="{{ $data->id }}"
                                        {{ $editPerchParty['product_id'] == $data->id ? 'selected' : '' }}>
                                        {{ $data->product_name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="price" value="{{ $editPerchParty->price }}"
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="qty_in_hand" type="text" name="qty_in_hand"
                            value="{{ $editPerchParty->qty_in_hand }}" />
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="qty_in_sold" type="text" name="qty_in_sold"
                            value="{{ $editPerchParty->qty_in_sold }}" />
                    </div>
                    <div class="input-form">
                        <x-base.form-label class="flex w-full flex-col sm:flex-row" htmlFor="validation-form-1"
                            for="inventry_value">
                        ...
                        <x-base.form-input class="form-control" id="inventry_value" name="inventry_value" type="text"
                            value="{{ $editPerchParty->inventry_value }}" />
                    </div>
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="sale_value" type="text" name="sale_value"
                            value="{{ $editPerchParty->sale_value }}" />
                    </div>
                    ...
                    <div class="input-form">
                        ...
                        <x-base.form-input class="form-control" id="avalible_stock" type="text" name="avalible_stock"
                            value="{{ $editPerchParty->avalible_stock }}" />
                    </div>
