...
@section('subhead')
    <title>Admin | Contect-Us List</title>
@endsection
...
@section('subcontent')
    ...
    <div class="intro-y mt-8 flex flex-col items-center sm:flex-row">
        <h2 class="mr-auto text-lg font-medium">Contect-Us List</h2>
        @if (session('success'))
        ...
        <div class="scrollbar-hidden overflow-x-auto">
            <div class="overflow-x-auto">
                <table data-tw-merge class="w-full text-left" id="example">
                    ...
                    <tbody>
                        @php $count = 1; @endphp
                        @foreach ($contect_usList as $item)
                            <tr data-tw-merge
                                class="[&amp;amp;:nth-of-type(odd)_td]:bg-slate-100 [&amp;amp;:nth-of-type(odd)_td]:dark:bg-darkmode-300 [&amp;amp;:nth-of-type(odd)_td]:dark:bg-opacity-50">
                                ...
                                {{-- <td data-tw-merge class="px-5 py-3 border-b dark:border-darkmode-300">
                                    <a class="mr-3 flex items-center" href="{{route('contect-us',$item->id  )}}"   >
                                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="Delete" icon-name="Delete" data-lucide="Delete" class="lucide lucide-Delete stroke-1.5 block"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                        Delete
                                    </a>
                                </td> --}}
                                ...
                                <td class="px-5 py-3 border-b dark:border-darkmode-300">
                                    <a class="mr-3 flex items-center" href="javascript:void(0);"
                                        data-href="{{ route('contect-us', $item->id) }}"
