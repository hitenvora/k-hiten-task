...
@section('subcontent')
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form class="customers-validate-form" action="{{ route('perchOrderReturnSubmit') }}" method="POST"
                                                ...
                                                <tr class="border-b border-bottom-dashed tax-tr">
                                                    ...
                                                    <td class="table__item-desc w-1/4">
                                                        <select data-tw-merge aria-label=".form-select-lg example"
                                                            ...
                                                            @foreach ($purcehseProductShow as $data)
                                                                <option value="{{ $data->id }}">
...
@section('js')
    ...
    <script>
        ...
        //         var url = '{{ url('fetchForPerchReturnOrder') }}';
        ...
        //                 console.log('Price Input:', priceInput);
        //                 if (priceInput) {
        //                     var price = parseFloat(data.data.product_price);
        //                     priceInput.value = price;
        //                 } else {
        //                     console.error('Price input not found.');
        //                 }
        ...
        //                 let totalGST = data.data.taxes;

        //                 const jsonObject = JSON.parse(data.data.taxes);
        ...
        //                 const gstAmount = price * (totalGST / 100);
        //                 // subtotal + totalGST
        //                 const totalPriceIncludingGST = parseFloat(price) + parseFloat(data.data.taxes);

        //                 var taxes = selectedRow.querySelector('.taxes');
        //                 if (taxes) {
        //                     taxes.value = totalGST;
        //                 } else {
        ...
        //                 }
        //                 var taxessum = data.data.taxes;
        //                 console.log('taxessum Input:', taxessum);
        //                 // var taxessum = 0;
        //                 // var elements = document.querySelectorAll('.taxes');
        //                 // for (var i = 0; i < elements.length; i++) {
        //                 //     var value = parseInt(elements[i].value);
            ...
            if (event.target && event.target.id === 'product') {
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        // console.log(data.data.per_kg_price, data.data.text_prize, 'huibiguvbuvgvvguvb');
