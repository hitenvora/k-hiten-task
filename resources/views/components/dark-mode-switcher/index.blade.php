...
<div
    class="dark-mode-switcher {{ $darkMode ? 'dark-mode-switcher--active' : '' }} box group fixed bottom-0 right-0 z-50 flex h-12 w-40 cursor-pointer items-center justify-center rounded-full border shadow-md"
