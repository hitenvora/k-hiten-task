...
<div @class([
    ...
    <div class="flex h-full items-center">
        ...
        <a href="" @class([
            ...
            <img {{-- class="w-6" --}} src="{{ Vite::asset('resources/images/kanaiya.png') }}" alt="Kanaiya" />
            {{-- <span @class([
        ...
        <div class="intro-x relative mr-3 sm:mr-6">
            <div class="search relative hidden sm:block" style="
            margin-top: 45px;
        ">
        ...
        <x-base.menu>
            <x-base.menu.button
                ...
                <img src="{{ Vite::asset($faker['photos'][0]) }}" alt="Midone Kanaiya" />
            </x-base.menu.button>
            <x-base.menu.items
